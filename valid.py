...
def valid(datacfg, cfgfile, weightfile, outfile):
    ...
    # TODO: set config file for calibration instead of hard-code
    ...
    for batch_idx, (data, target) in enumerate(test_loader):
        ...
        # Wrap tensors in Variable class, set volatile=True for inference mode
        # and to use minimal memory during inference
        ...
        for i in range(output.size(0)):
            ...
            # For each image, get all the targets (for multiple object pose estimation,
            # there might be more than 1 target per image)
